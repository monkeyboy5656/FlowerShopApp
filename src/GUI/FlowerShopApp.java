...
public class FlowerShopApp {
    ...
    private static void showCustomerMenu(Scanner scanner, Customer customer) {
        ...
        while (customerRunning) {
            System.out.println("\n--- Customer Menu ---");
            System.out.println("1. View shop");  //done
            System.out.println("2. Sort products by color");  //done
            System.out.println("3. Sort products by price");  //done
            System.out.println("4. Sort products by type");   //done
            System.out.println("5. Add item to cart");        //done
            System.out.println("6. Update item quantity in cart");   //done
            System.out.println("7. Remove item from cart");     //done
            System.out.println("8. View cart");             //done
            System.out.println("9. Place order");           //done
            System.out.println("10. View favorite products");    //done
            System.out.println("11. Add product to favorites");  //done
            System.out.println("12. Remove product from favorites");  //done
            System.out.println("13. View Orders");
            System.out.println("14. Cancel Order");
            System.out.println("15. Log out");  //done
            System.out.print("Enter your choice: ");
